...
//MARK: -  Get Spirit Photos
extension SpiritViewController {
    func getSpiritPhotos() {
        NetworkManager().fetchSpiritPhotos(page: pageCounter) { [weak self] photoResponse in
...
extension SpiritViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: K.spiritCell.rawValue, for: indexPath) as? SpiritCollectionViewCell else { return UICollectionViewCell() }
